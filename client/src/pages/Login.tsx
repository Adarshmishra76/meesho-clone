...
const Login = () => {
    ...
    const submitHandler = (e: React.FormEvent) => {
        e.preventDefault();
        dispatch(login({ emailOrPhone: identifier, password }));
    };
        ...
        <div className="min-h-screen flex items-center justify-center bg-gray-100 py-12 px-4 sm:px-6 lg:px-8 bg-cover bg-center" style={{ backgroundImage: "url('https://img.freepik.com/free-vector/white-abstract-background-design_23-2148825582.jpg?w=1380&t=st=1685445277~exp=1685445877~hmac=6c747758368165737577575757')" }}>
            <div className="max-w-md w-full space-y-8 p-10 rounded-2xl shadow-2xl bg-gradient-to-br from-violet-500 to-fuchsia-600 text-white relative overflow-hidden">
                ...
                <div className="flex flex-col items-center mb-6">
                    <h1 className="text-4xl font-bold tracking-wider uppercase mb-2">Welcome Back</h1>
                    <h2 className="text-lg font-light tracking-widest uppercase opacity-80">Log In</h2>
                </div>
                ...
                <form className="mt-8 space-y-6" onSubmit={submitHandler}>
                    <div className="space-y-6">
                        <div className="relative">
                            <div className="absolute inset-y-0 left-0 pl-0 flex items-center pointer-events-none">
                                <span className="text-white text-lg"><i className="fas fa-user"></i></span>
                                {/* Using simple text label/icon if FA not avail, or SVG */}
                    ...
                    <div className="flex flex-col items-center space-y-2">
                        <a href="#" className="font-medium text-gray-200 hover:text-white text-sm">
                            Forgot Password?
                        </a>
            ...
            {/* Background elements to match the city feel if possible, or just clean */}
        </div>
    );
};
